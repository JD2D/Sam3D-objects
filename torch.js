  ...
  run: [
    // windows nvidia
    {
      ...
      "params": {
        ...
        "message": [
          "uv pip install torch==2.5.1 torchvision==0.20.1 torchaudio==2.5.1 --index-url https://download.pytorch.org/whl/cu121 --force-reinstall --no-deps",
          "{{args && args.xformers ? 'uv pip install xformers==0.0.28.post3 --index-url https://download.pytorch.org/whl/cu124 --force-reinstall --no-deps' : ''}}",
          "{{args && args.triton ? 'uv pip install triton-windows==3.2.0.post19' : ''}}"
        ]
      },
      "next": null
    },
